# Generated by Django 3.1.3 on 2020-12-12 15:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.CharField(default='/static/ints/avatar/default_user_avatar.png', max_length=520)),
                ('transactions', models.ManyToManyField(blank=True, to='ints.Transaction')),
